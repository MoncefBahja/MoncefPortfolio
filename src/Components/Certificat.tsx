...
import { IconBriefcaseFilled, IconGitBranch, IconGitCommit, 
    IconGitPullRequest, IconMessageDots } from "@tabler/icons-react";
...
const TimelineItem = (items: any) => {
    ...
    <Timeline.Item data-aos="fade-up" data-aos-duration="800"
        key={index} className="!pt-12 !mb-2 sm-mx:!p-1"
        bullet={<TbCertificate className="!text-bgColor" size={size} />} >
                ...
                {item.desc}
                    ...
                    <a href={item.link} target="_blank"
                     className="!w-[48%] sm-mx:!w-[46%]">
                        <Button variant="outline"  color="#0969da" 
                    fullWidth  radius="md">
                        View 
                    </Button>
                    </a>
...
const Certificat = () => {
    ...
    return <div className="px-16 mx-20 md-mx:px-6 sm-mx:px-2 lg-mx:mx-0 my-10 mb-28 font-mono" id="Certificate">
        <h1 className="text-4xl sm-mx:text-3xl xs-mx:text-2xl  mb-10 font-bold text-center text-white"><span className="text-primaryColor">04.&nbsp;</span>Certificate</h1>
        <Timeline color="#0969da" active={5} bulletSize={dot} lineWidth={2}>
            {
                TimelineItem(CertificatInfo)
            }
